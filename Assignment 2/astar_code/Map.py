...
class Map_Obj():
    def __init__(self, task=1):
        ...
        self.tick_counter = 0
        self.scale = 20  # Scale for image of map
    ...
    def get_map_image(self, map=None):
        """
        A function used to draw the map as an image and return it.
            ...
            for x in range(width):
                ...
                for i in range(self.scale):
                    for j in range(self.scale):
                        pixels[x * self.scale + i,
                               y * self.scale + j] = colors[map[y][x]]
